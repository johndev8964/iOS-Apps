//
//  VerificationEmailViewController.m
...
@interface VerificationEmailViewController ()

@end

@implementation VerificationEmailViewController
...
- (IBAction) goSubmit:(id)sender {
    ...
    [[APIService sharedManager] resendConfirmEmail:udid email:@"" onCompletion:^(NSString *result, NSError *error) {
